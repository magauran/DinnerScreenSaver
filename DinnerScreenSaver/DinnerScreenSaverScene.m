...
- (void)setupLabels {
    ...
    [_timerLabel setFontColor:[NSColor colorFromHexadecimalValue:[[self defaults] objectForKey:@"textColor"]]];
    ...
    [_dinnerLabel setFontColor:[NSColor colorFromHexadecimalValue:[[self defaults] objectForKey:@"textColor"]]];
